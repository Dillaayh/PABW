    ...
    <aside className="w-64 bg-[#3D5895] text-white p-6 flex flex-col justify-between rounded-r-3xl">
      <div>
        ...
        <nav className="space-y-4 text-sm" aria-label="Sidebar menu hotel">
          <Link
            href="/pages/mitra/penerbangan/kelolaPenerbangan"
            className={`block rounded-full px-4 py-2 w-full text-left font-semibold ${
              pathname === '/pages/mitra/penerbangan/kelolaPenerbangan'
          ...
          <Link
            href="/pages/mitra/penerbangan/melihatStatus"
            className={`block rounded-full px-4 py-2 w-full text-left font-semibold ${
              pathname === '/pages/mitra/penerbangan/melihatStatus'
                ? 'bg-white text-[#3D5895]'
                : 'text-gray-300 hover:text-white hover:underline transition'
            }`}
          >
          ...
          <Link
            href="/pages/mitra/penerbangan/melihatKetersediaan"
            className={`block rounded-full px-4 py-2 w-full text-left font-semibold ${
              pathname === '/pages/mitra/penerbangan/melihatKetersediaan'
                ? 'bg-white text-[#3D5895]'
                : 'text-gray-300 hover:text-white hover:underline transition'
            }`}
          >
