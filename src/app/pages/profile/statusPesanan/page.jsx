                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      {item.type === "hotel" ? (
                        <>
                          <p>
                            Check-in <span className="p-8">{item.checkin}</span>
                          </p>
                          <p>
                            Check-out{" "}
                            <span className="p-6">{item.checkout}</span>
                          </p>
                        ...
                        <>
                          <p>
                            Berangkat{" "}
                            <span className="p-8">{item.berangkat}</span>
                          </p>
                          <p>
                            Tiba <span className="p-17">{item.tiba}</span>
                          </p>
