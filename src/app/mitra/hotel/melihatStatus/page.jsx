...
import dataJson from '@/app/mitra/data.json';
import SidebarMitraHotel from '@/app/components/sidebarMitra/hotel/page';
...
export default function MelihatStatus() {
  ...
  useEffect(() => {
    ...
    // Pastikan data ini nanti di-fetch dari backend atau data.json yang sebenarnya
    ...
    const kamarWithStatus = dataJson.kamarHotel.map((item, index) => ({
      ...item,
      identitas: ['Alifah Nur Aisyah', 'Dilla Ayu', 'Desti Nur Irawati', 'Syifa Maulida'][index % 4] || 'Tamu', // Pastikan index tidak melebihi array
